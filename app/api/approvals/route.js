...
export async function POST(req){
 ...
 if((await sql`select id from approvals where record_id=${record.id} limit 1`).length)return Response.json({error:'Approval workflow already started'},{status:409})
