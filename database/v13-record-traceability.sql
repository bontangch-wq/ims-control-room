create table if not exists record_links (
  ...
  source_record_id bigint not null references ims_records(id) on delete cascade,
  target_record_id bigint not null references ims_records(id) on delete cascade,
